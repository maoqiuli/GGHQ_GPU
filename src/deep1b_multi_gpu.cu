...
DEFINE_string(query_attr_filename, "/home/maoqiuli21/nfs/data/label/label_deep_query_value_16_labeldim_16.txt", "path to file with query attributes");
DEFINE_string(groundtruth_filename, "/home/maoqiuli21/nfs/data/label/deep_groundtruth_label_value_16_labeldim_16.bin", "path to file with groundtruth");
