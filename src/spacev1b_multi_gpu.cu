...
DEFINE_string(base_filename, "/home/maoqiuli21/nfs/data/spacev/", "path to file with base vectors");
DEFINE_string(query_filename, "/home/maoqiuli21/nfs/data/spacev/", "path to file with perform_query vectors");
...
int main(int argc, char* argv[]) {
  ...
  //
  // dataset configuration (here: spacev1B)
  //
  ...
  std::string base_filename = FLAGS_base_filename + 
              "spacev" + std::to_string(N_base_fac) + "m/base." + std::to_string(N_base_fac) + "m.i8bin";
  std::string query_filename = FLAGS_query_filename + 
              "query.i8bin";
  std::string base_attr_filename = FLAGS_base_attr_filename + 
              "label_spacev" + base + "_base_value_" + std::to_string(DBA) + ".txt";
  std::string query_attr_filename = FLAGS_query_attr_filename + 
              "label_spacev" + base + "_query_value_" + std::to_string(DBA) + "_labeldim_" + std::to_string(DA) + ".txt";
  std::string groundtruth_filename = FLAGS_groundtruth_filename + 
              "spacev" + base + "_groundtruth_label_value_" + std::to_string(DBA) + "_labeldim_" + std::to_string(DA) + ".bin";
  std::string graph_dir = FLAGS_graph_dir + 
              "spacev" + std::to_string(N_base_fac) + "m_" + std::to_string(DBA) + "/";
